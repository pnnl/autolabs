...
def save_tags_txt():
    data = [
        {
            "Add naphthalene to vials in Plate1. {A1: 5, A2: 10, A3: 15, A4: 20, B1: 25, B2: 30, B3: 40, B4: 50}": [
                "Powder"
            ]
        },
        {
            "Set Cap vials in Plate1. {A1: 1, A2: 1, A3: 1, A4: 1, B1: 1, B2: 1, B3: 1, B4: 1}": [
                "Processing",
                "ScrewCap",
            ]
        },
        {
            "Set VortexRate in vials in Plate1. {A1: 1, A2: 1, A3: 1, A4: 1, B1: 1, B2: 1, B3: 1, B4: 1}": [
                "Processing"
            ]
        },
        {
            "Set Delay to 10 min in vials in Plate1. {A1: 10, A2: 10, A3: 10, A4: 10, B1: 10, B2: 10, B3: 10, B4: 10}": [
                "Processing"
            ]
        },
        {
            "Add 5 ul from Plate1 to Plate2. {A1:a2, A2:b3, A3:a3}": [
                "ExtSingleTip",
                "SyringePump",
            ]
        },
...
def get_exp_dir():
    mydir = os.path.join(
        os.getcwd(), "experiments", datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    )
    try:
        os.makedirs(mydir)
    except OSError as e:
