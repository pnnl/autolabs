...
class Graph:
    ...
    def __init__(self, use_self_checks, use_self_checks_reasoning, use_tools):
        ...
        init_graph_variables(use_self_checks=self.use_self_checks, use_self_checks_reasoning=self.use_self_checks_reasoning,
                             use_tools=self.use_tools, use_reflection=self.use_reflection, 
    ...
    def build_graph(self):
        ...
        from src.react_agents import processing_steps_node, final_steps_node, calculation_node
        from src.react_agents import self_checks_node, self_checks_with_reasoning_node, reflection_node
        from langgraph.graph import StateGraph, START
        from src.react_agents import State
    ...
    def compile_graph(self):
        ...
        st.session_state['graph_runnable'] = self.graph.compile(checkpointer = st.session_state['memory'])
...
def invoke_our_graph(st_messages, callables):
    ...
    return st.session_state['graph_runnable'].invoke({"messages": st_messages}, config={"callbacks": callables+[st.session_state.callback_handler], "thread_id": "1", 'recursion_limit': 30})
...
class SingleGraph:
    ...
    def __init__(self, use_self_checks, use_self_checks_reasoning, use_tools):
        ...
        init_graph_variables(self.use_self_checks, use_self_checks_reasoning=self.use_self_checks_reasoning,
                             use_tools=self.use_tools, use_reflection=self.use_reflection, 
                             redo_calculations=self.redo_calculations)
